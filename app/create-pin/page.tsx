...
function page() {
  ...
  return (
    <div className='flex flex-col  items-center mr-5 h-screen mt-5'>
      {fields && (
      ...
      <div className='flex lg:flex-row flex-col justify-center items-center bg-white lg:p-5 p-3 lg:w-4/5 w-full'>
        ...
        {user && (
          <div className='flex gap-2 my-2 items-center bg-white rounded-lg'>
            <img src={user.image} className='w-10 h-10 rounded-full' alt="User profile picture" />
        ...
        <div className='flex flex-col'>
          <div>
            <p className='mb-2 font-semibold text-lg sm:text sm:text-xl'>Choose pin category</p>
          ...
          <div className='felx justify-end items-end mt-5'>
